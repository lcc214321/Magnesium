...
public enum ErrorCodesEnum {
    ...
    SIGN_ERROR("1201010002","签名校验异常"),
    TIME_STAMP_ERROR("1201010003","过时的请求"),
    //02
    NONE_QUERY_DATA("1201020001","没有对应的数据"),
    //03
    CACHE_DATA_ERR("1201030001","缓存数据异常"),
    //05
    READ_VALUE_FROM_APOLLO("1201050001","从配置中心获取信息失败"),
    CLOUD_API_ERR("1201050002","从接口获取数据异常"),
    //07
    JSON_CAST_ERROR("1201070001","序列化JSON异常"),
    REF_ERROR("1201070002","反射属性异常"),
    //08
