...
public class TtenantInfoModifyResp {
     ...
     * 所在省
     */
    @EnumDeserialize(using = ProvinceCodeEnum.class)
     ...
     * 所在市
     */
    @EnumDeserialize(using = CityCodeEnum.class)
     ...
     * 注册:0, 使用:1, 冻结:2, 注销:3
     */
    @EnumDeserialize(using = TenantInfoStatusEnum.class)
